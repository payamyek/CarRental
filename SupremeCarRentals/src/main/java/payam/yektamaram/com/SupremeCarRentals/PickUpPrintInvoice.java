...
public class PickUpPrintInvoice 
{
	File pdf = new File("/SupremeCarRental/SupremeCarRentals/dropOffInvoice.pdf");

	public PickUpPrintInvoice() throws IOException, PrinterException {
